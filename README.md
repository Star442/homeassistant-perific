...
4. Add this URL: `https://github.com/Star442/homeassistant-perific`
5. Select "Integration" as the category
6. Click "Create custom repository"
7. Search for "Perific Energy Meter" and install it
8. Restart Home Assistant
9. Go to Settings → Devices & Services → Add Integration
10. Search for "Perific Energy Meter"
11. Enter your Perific account email and authentication token
